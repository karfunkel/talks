...
slide(
    ...
    migLayout(layoutConstraints: 'fill',
            ...
            rowConstraints: '10[center]50[center]35[center]25[center][grow]10')
    label('', constraints: 'spany 5, grow')
    label(id: 'vielenDank', "Vielen Dank", cssClass: 'H1w', constraints: 'spanx 2')
    label('', constraints: 'spany 5, grow, wrap')
    widget(new ImagePanel(), imagePath: 'AlexanderKlein.png', preferredSize: [140, 185], opaque: false, constraints: 'spany 3, left, top')
